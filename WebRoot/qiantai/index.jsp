	        ...
	        <td align="left" valign="top">
	            <%-- <div style="width:900px;margin-top: 1px;">
				 ...
				 <div style="width:900px;margin-top: 1px;">
					...
					<script>
						PImgPlayer.addItem( "test1", "#", "/zxwz/images/11.jpg");
						PImgPlayer.addItem( "test2", "#", "/zxwz/images/22.jpg");
						PImgPlayer.init( "imgADPlayer", 900, 300 );
					</script> -->
					<img src="/zxwz/images/11.jpg" width="900" height="300"/>
				 </div>
				 <div style="width:900px;margin-top: 10px;">
				      <div style="height:24px;background:url(<%=path %>/images/left111.jpg);">
				         <span style="float:left;font-family: 微软雅黑;font-size: 12px;margin-top: 3px;margin-left: 10px;">系统介绍</span>
				      </div>
